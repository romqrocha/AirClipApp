...
/// </summary>
/// <author>
/// <see href="https://github.com/radiolondra">radiolandra</see>
/// </author>
/// <remarks>
/// Modifications by Rodrigo Rocha
/// </remarks>
public class VideoView : NativeControlHost    
{
    ...
    private readonly BehaviorSubject<Maybe<MediaPlayer>> _mediaPlayers = 
        new(Maybe<MediaPlayer>.None);
    private readonly BehaviorSubject<Maybe<IPlatformHandle>> _platformHandles = 
        new(Maybe<IPlatformHandle>.None);
    ...
    public VideoView()
    {            
        _attacher = _platformHandles.WithLatestFrom(_mediaPlayers).Subscribe(x =>
        {
        ...
        ContentProperty.Changed.AddClassHandler<VideoView>((s, _) 
            => s.InitializeNativeOverlay());
        IsVisibleProperty.Changed.AddClassHandler<VideoView>((s, _) 
            => s.ShowNativeOverlay(s.IsVisible));
    }

    public MediaPlayer MediaPlayer
    {
        get => _mediaPlayers.Value.GetValueOrDefault();
    ...
    private void InitializeNativeOverlay()
    {
        ...
        if (_floatingContent == null && Content != null)            
        {
            ...
            {
                throw new NullReferenceException("VisualRoot is Null in Unofficial LibVLCSharp");
            }
        }
    ...
    protected override IPlatformHandle CreateNativeControlCore(IPlatformHandle parent)
    {
        ...
        _platformHandles.OnNext(Maybe<IPlatformHandle>.From(handle));
        Handle = handle;
        return handle;
    }
    ...
    protected override void DestroyNativeControlCore(IPlatformHandle control)
    {
        ...
        _mediaPlayers.Value.Execute(MediaPlayerExtensions.DisposeHandle);
    }
